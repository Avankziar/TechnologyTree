...
public class GroupEntryQueryStatus implements MysqlHandable
{
	private int id;
	...
	public GroupEntryQueryStatus()
	{
		
	}
	
	public GroupEntryQueryStatus(int id, String internName, String groupName,
	...
	public boolean create(Connection conn, String tablename)
	{
		try
		{
			String sql = "INSERT INTO `" + tablename
					+ "`(`intern_name`, `group_name`, `entry_query_type`, `status_type`, `research_level`, `duration_until_expiration`) " 
					+ "VALUES(?, ?, ?, ?, ?, ?)";
			PreparedStatement ps = conn.prepareStatement(sql);
	        ps.setString(1, getInternName());
	        ps.setString(2, getGroupName());
	...
	public boolean update(Connection conn, String tablename, String whereColumn, Object... whereObject)
	{
		try
		{
			String sql = "UPDATE `" + tablename
				+ "` SET `intern_name` = ?, `group_name` = ?, `entry_query_type` = ?, `status_type` = ?, `research_level` = ?,"
	...
	public ArrayList<Object> get(Connection conn, String tablename, String orderby, String limit, String whereColumn, Object... whereObject)
	{
		try
		{
			...
			while (rs.next()) 
			{
				al.add(new GroupEntryQueryStatus(rs.getInt("id"),
	...
	public static ArrayList<GroupEntryQueryStatus> convert(ArrayList<Object> arrayList)
	{
		ArrayList<GroupEntryQueryStatus> l = new ArrayList<>();
		for(Object o : arrayList)
		{
			if(o instanceof GroupEntryQueryStatus)
			{
				l.add((GroupEntryQueryStatus) o);
			}
		}
		return l;
	}
